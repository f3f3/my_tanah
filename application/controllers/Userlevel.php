...
class Userlevel extends CI_Controller
{
    ...
    public function akses_json($level) {
        header('Content-Type: application/json');
        echo $this->User_level_model->akses_json($level);
    }
    ...
    public function save_action(){
        $data = array('nama_level' => $this->input->post('nama_level',TRUE));
        if($this->User_level_model->insert($data)!==False){
