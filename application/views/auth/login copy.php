    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>/adminlte/index2.html"><b>Inventory</b> System</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <?php echo form_open('auth/cheklogin'); ?>
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" name="ids" placeholder="Username">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="col-xs-12">
                            <div class="callout callout-info">
                                ...
                                <p><b>Email</b> : admin@administrator.com</p>
